			...
			<div class="col-md-5 agileits_w3layouts_contact_gridl">
				...
				<div class="col-md-7 w3l_contact_form">
					...
					<table style="border:4px solid black;" >
						...
						<tr><td>
							<input type="text" name="np" placeholder="Enter New Password"  required="">
							</td>
							<td colspan="2">&nbsp;</td>
						</tr>
						<tr><td>
							<input type="text" name="cnp" placeholder="Confirm Pasword"  required="">
							</td>
							<td colspan="2">&nbsp;</td>
						</tr>
						...
						<td align="center">
						<input type="submit" name="action" value="new password"></td>
						<td>&nbsp;</td>
						</tr>
						<tr>
						<td colspan="3">&nbsp;</td>
