	...
	<div class="w3ls-section contact">
		<div class="container"> 
			<div class="w3ls-title">
				<h2 class="h3-w3l">Customer Experience</h2> 
			</div>  
			...
			<div class="col-md-5 agileits_w3layouts_contact_gridl">
					<div class="agileits_mail_grid_right_grid">
						...
						<br><br>
						<h4>
						<%String reviewed=(String)request.getAttribute("reviewed"); %>
						<%if(reviewed!=null){
							out.print(reviewed);
				...
				<div class="col-md-7 w3l_contact_form">
					...
					<table style="border:4px solid black;" >
						...
						<tr>
							<td align="center" colspan="5"><input type="text" name="review" placeholder="Type Your Review"  required="">
						</td>
...
<div class="w3_agile-copyright text-center">
		<p>©  Design by  <a href="//shivparekh803@gmail.com/">Shaishav Parekh</a></p>
	</div>
<!--//footer-->	
	<!-- subscribe -->
