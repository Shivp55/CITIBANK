			...
			<div class="col-md-5 agileits_w3layouts_contact_gridl">
				...
				<div class="col-md-7 w3l_contact_form">
					...
					<table style="border:4px solid black;" >
						...
						<td>
							<input type="text" name="op" placeholder="Enter Old Password" >
							</td>
							<td colspan="2">&nbsp;</td>
						</tr>
						<tr>
						<td>
							<input type="text" name="np" placeholder="Enter New Password">
							</td>
						</tr>
						...
						<tr>
							<td align="center" colspan="5"><input type="text" name="cnp" placeholder="Confirm New Password"  >
						</td>
						...
						<td>&nbsp;</td>
						<td align="center">
						<input type="submit" name="action" value="change"></td>
						<td>&nbsp;</td>
						</tr>
						<tr>
						<td colspan="3">&nbsp;</td>
